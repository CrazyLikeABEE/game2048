...
public class Game2048 extends JPanel {
	...
	boolean canMove() {
		...
		//use function/method inside the canMove() function
		if (isFull() == false) {
			return true;
		}
...
//		static int myHighScore = 0;
//		File scoreFile = new File("scoreFile.txt");
//
//		try {
//			BufferedWriter scoreKeeper = new BufferedWriter(new FileWriter(scoreFile));
//			scoreKeeper.write(myHighScore);
//			scoreKeeper.close();
//		} catch (IOException e) {
//			e.printStackTrace();
//		}
...
//	}
	...
	private void drawTile(Graphics g2, Tile tile, int x, int y) {
		...
		//int highScore = scoreFile.myHighScore;
		g.setFont(new Font(FONT_NAME, Font.PLAIN, 18));
		g.setColor(new Color(78, 139, 202));
		g.drawString("Highscore: " /*+ highScore*/, 50, 365);
	}
